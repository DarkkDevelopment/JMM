...
function AddEmployee(props) {
  ...
  const handleSave = async (e: any) => {
    ...
    let emp = {
      ...
      Beta2aWesh: bta2aFace.fileInfo?.name || null,
      Beta2aDahr: bta2aDahr.fileInfo?.name || null,
      Feesh: feesh.fileInfo?.name || null,
      ShehadetMilad: birthCertificate.fileInfo?.name || null,
      ShehadetGeish: tagneedCertificate.fileInfo?.name || null,
      PersonContract: contractImage.fileInfo?.name || null,
