...
const DeletedEmployees = (props: InferGetServerSidePropsType<typeof getServerSideProps>) => {
    ...
    const reassignEmployee = async (id: number) => {
        await axios.post(`/api/HR_Endpoints/employee/reAssignByCode`, {
            code: id
        }).then(() => {
            ...
            <div className="bg-gray-100 font-display basis-5/6">
                ...
                <div className="flex flex-col flex-1 p-10 space-y-2 jusify-center ">
                    ...
                    <div className="flex flex-col pt-10 pl-10 pr-10 mr-10 bg-white shadow-xl space-y-7">
                        {
                            filteredEmployees.length > 0 ? (<table className="text-right border-collapse table-fixed font-display">
                            ...
                            </table>) : <div className='mb-6'><NoDataComponent /></div>
                        }
                    </div>
