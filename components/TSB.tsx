...
const NestedList = (props: any) => {
  ...
  return (
    ...
    >
      ...
      <Collapse in={open} timeout="auto" unmountOnExit>
        ...
        <ListItemButton sx={{ paddingX:6 ,marginTop:2 , marginBottom:2  ,justifyContent:'space-between' }} onClick={() => {
  ...
  <div><Image src={employeeLogo} alt="employee" width={50} height={50} /></div>
          ...
          <div >
            ...
            <div >  <Image src={vacationLogo} alt="employee" width={50} height={50} />
          </div>
          </ListItemButton>
          ...
          <div className="items-center ">
            ...
            <div >  <Image src={moneyLogo} alt="employee" width={50} height={50} />
          </div>
          </ListItemButton>
